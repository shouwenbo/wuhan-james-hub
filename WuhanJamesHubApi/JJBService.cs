        ...
        public List<Member>? LoadMemberList(List<List<string>> request, out string errMsg)
        {
            JJBRowIndexOptions rowIndexOptions = new JJBRowIndexOptions()
            {
                List = new List<JJBRowIndexItem>()
                {
                    ...
                    new JJBRowIndexItem(){ Index = 9, Name = "电话" },
                    new JJBRowIndexItem(){ Index = 10, Name = "身高" },
                    new JJBRowIndexItem(){ Index = 11, Name = "血型" },
                    new JJBRowIndexItem(){ Index = 12, Name = "婚否" },
                    new JJBRowIndexItem(){ Index = 13, Name = "CD类型" },
                    new JJBRowIndexItem(){ Index = 14, Name = "出身教团" },
                    new JJBRowIndexItem(){ Index = 15, Name = "其他宗教" },
                    new JJBRowIndexItem(){ Index = 16, Name = "教会名" },
                    new JJBRowIndexItem(){ Index = 17, Name = "职分" },
                    new JJBRowIndexItem(){ Index = 18, Name = "信仰时间" },
                    new JJBRowIndexItem(){ Index = 19, Name = "母胎信仰" },
                    new JJBRowIndexItem(){ Index = 20, Name = "邮箱" },
                    new JJBRowIndexItem(){ Index = 22, Name = "最终学历" },
                    ...
                    new JJBRowIndexItem(){ Index = 37, Name = "兄弟姐妹关系" },
                    new JJBRowIndexItem(){ Index = 39, Name = "家族事项1姓名" },
                    new JJBRowIndexItem(){ Index = 40, Name = "家族事项1性别" },
                    new JJBRowIndexItem(){ Index = 41, Name = "家族事项1生日" },
                    new JJBRowIndexItem(){ Index = 42, Name = "家族事项1关系" },
                    new JJBRowIndexItem(){ Index = 43, Name = "家族事项1出席教会" },
                    new JJBRowIndexItem(){ Index = 44, Name = "家族事项1SCJ工号" },
                    new JJBRowIndexItem(){ Index = 45, Name = "家族事项2姓名" },
                    new JJBRowIndexItem(){ Index = 46, Name = "家族事项2性别" },
                    new JJBRowIndexItem(){ Index = 47, Name = "家族事项2生日" },
                    new JJBRowIndexItem(){ Index = 48, Name = "家族事项2关系" },
                    new JJBRowIndexItem(){ Index = 49, Name = "家族事项2出席教会" },
                    new JJBRowIndexItem(){ Index = 50, Name = "家族事项2SCJ工号" },
                }
            };
            ...
            try
            {
                ...
                if (request[0].Count == 50) // 1个学历
                {
                    dynamicRowCount = 0; // 动态增加0行
                    educationNumber = 1;
                }
                else if (request[0].Count == 55) // 2个学历
                {
                    dynamicRowCount = 5; // 动态增加5行
                    educationNumber = 2;
                }
                else if (request[0].Count == 60) // 3个学历
                {
                    dynamicRowCount = 10; // 动态增加10行
                    educationNumber = 3;
                }
                else if (request[0].Count == 65) // 4个学历
                {
                ...
                {
                    errMsg = $"表格的行数不正确，行数只能为50/55/60/65，您的行数是{request[0].Count}";
                    return null;
                }

                for (int i = 0; i < educationNumber; i++)
                {
                    rowIndexOptions.List.Add(new JJBRowIndexItem() { Index = 23 + (i * 5), Name = $"学历信息{i + 1}分类" });
                    rowIndexOptions.List.Add(new JJBRowIndexItem() { Index = 24 + (i * 5), Name = $"学历信息{i + 1}学校名" });
                    rowIndexOptions.List.Add(new JJBRowIndexItem() { Index = 25 + (i * 5), Name = $"学历信息{i + 1}专业" });
                    rowIndexOptions.List.Add(new JJBRowIndexItem() { Index = 26 + (i * 5), Name = $"学历信息{i + 1}状态" });
                    rowIndexOptions.List.Add(new JJBRowIndexItem() { Index = 27 + (i * 5), Name = $"学历信息{i + 1}期间" });
                }
