...
namespace WuhanJamesHubApi
{
    public class Member
    {
        ...
        public List<string> Check()
        {
            ...
            {
                result.Add($"现住址中文:{CurrentAddressChinese} 不能为空");
            }
            else if (!CurrentAddressChinese.IsChineseAddress())
            {
                result.Add($"现住址中文:{CurrentAddressChinese} 不符合规范");
            }
            ...
            if (!validBirthFamilyMemberList.CheckDesc(p => p.Birth))
            {
