<template>
  ...
  <div v-if="filteredErrContentList.length > 0" style="margin-top: 30px">
    <div>
    ...
    <el-tabs class="demo-tabs">
      <el-tab-pane
        :label="item.title"
        v-for="(item, index) in filteredErrContentList"
        :key="index"
      >
        <el-card>
          <template #header>
    ...
    <el-text size="large" style="color: #8b0000"
      >若发现检测异常，请通过 xz zz 向上反馈</el-text
    >
  </div>
</template>
